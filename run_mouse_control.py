...
def mouse_mov(x, y):
    os.system("xdotool mousemove " + str(int(x*12.5)) + " " + str(int(y*12.5)))
...
def hand_find(img):
    ...
    if count_defects == 1:
        cv2.putText(img, "Numero 1", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
    elif count_defects == 2:
        str = "Numero 2"
        cv2.putText(img, str, (5, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, 2)
    elif count_defects == 3:
        cv2.putText(img, "Numero 3!", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
    elif count_defects == 4:
        cv2.putText(img, "Numero 4", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
    else:
        cv2.putText(img, "Numero 5", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
